...
export function ToStationList({toQuery, setToQuery, setToggleToList} : ToStationsListProps) {
    ...
    return (
        <div className={`${filteredStations ? "h-[337px]" : "h-40"}  w-full flex z-10 absolute top-[3.25rem] lg:top-[7rem] right-0 bg-white border-[1px] border-[#07072126] overflow-scroll rounded lg:w-[calc(50%_-_20px)]`}>
            {!filteredStations ? (

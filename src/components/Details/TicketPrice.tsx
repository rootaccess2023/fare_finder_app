        ...
        <div className="flex flex-col gap-4 p-4 border-b">
            <div className="flex justify-between">
                <div className="text-primary text-sm font-light">
                    ...
                    <span>
                        PHP {ticketType === "sjt" ? fareDetails.sjt_fare : fareDetails.svt_fare}
                    </span>
                        <span className="absolute left-[7.7rem] top-1 text-2xl border-b-2 border-primary">.00</span>
                    </h1>
                    <span>single way, standard, {ticketType === 'sjt' ? <span>full price</span> : <span>discounted price</span>}</span>
                </div>
